...
Your task is to make sure the COSMIC integration as seamless as possible. Last year, one of the contributors
made progress on many of the project objectives. You can read more about their work [here](https://github.com/sandptel/gsoc25/).

The goal for the project is to have a working COSMIC based session that is on par or better in terms of
...
- Regolith Look based themes should be integrated with COSMIC components (optional).
...
- Replicate the setup described in the [previous year's project](https://github.com/sandptel/gsoc25/).
- Identify the list of things that work perfectly vs stuff that needs better integration.
- Come up with a plan and prove that you can execute on it by implementing its initial
  steps.

### Resources

- Previous Years project - [repo](https://github.com/sandptel/gsoc25/).
- Repo containing all the COSMIC components [here](https://github.com/pop-os/cosmic-epoch).
- There is an excellent [talk](https://www.youtube.com/watch?v=bwrBKccfYws) that goes over the choices the architecture, design and ideology of COSMIC. Watching this is pretty much a requirement for qualifying.
